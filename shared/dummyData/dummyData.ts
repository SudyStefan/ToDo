import { ToDoEntry, ToDoStatus, ToDoType, TimeInSeconds } from "../types/ToDoEntry";
...
export const DummyData: ToDoEntry[] = [
  ...
  { id: 11, text: 'Küche', status: ToDoStatus.Done, creationDate: new Date("2025-10-01"), type: ToDoType.Periodic, lastChecked: new Date("2025-10-20"), period: TimeInSeconds.Week * 2 },
  { id: 12, text: 'Dusche', status: ToDoStatus.Done, creationDate: new Date("2025-10-01"), type: ToDoType.Periodic, lastChecked: new Date("2025-10-20"), period: TimeInSeconds.Week * 3 },
  { id: 13, text: 'Klo', status: ToDoStatus.Done, creationDate: new Date("2025-10-01"), type: ToDoType.Periodic, lastChecked: new Date("2025-10-20"), period: TimeInSeconds.Week },
  { id: 14, text: 'Gang', status: ToDoStatus.Done, creationDate: new Date("2025-10-01"), type: ToDoType.Periodic, lastChecked: new Date("2025-10-20"), period: TimeInSeconds.Week * 4 },
];